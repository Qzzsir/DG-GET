...
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        #self.atten_para = atten_para  # 新增参数存储
    ...
    Outputs:
        ...
        """
        # print("activation 1147 forward",atten_para.shape)
        why_not_fast_path = ''
        ...
        atten_para = atten_para.transpose(1, 0)
        ...
        if not self._qkv_same_embed_dim:
            ...
            attn_output, attn_output_weights = F.multi_head_attention_forward(
                ...
                #atten_para=self.atten_para,  # 新加入的参数
                average_attn_weights=average_attn_weights,
                is_causal=is_causal)
        else:#this one
            # print("activation 1282 para", atten_para.shape)# torch.Size([16, 200, 200])
